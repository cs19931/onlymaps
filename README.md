# 🗺️ onlymaps - Simple Database Management Made Easy
...
You can check your Python version by opening a command prompt or terminal and typing:
...
4. Run the installer by double-clicking the file and following the prompts.

## 🔧 Configuration
After installation, you will need to configure your database connection:

1. Open the onlymaps application.
2. In the interface, you'll see options to input your database credentials.
3. Enter the host, username, password, and database name.
4. Click "Connect" to establish the connection.

You’re now ready to start managing your databases!

## 🌐 Features
- **Support for Multiple Databases:** Connect with MariaDB, MySQL, PostgreSQL, SQLite, and SQL Server.
- **User-Friendly Interface:** Simple design for easy use.
- **Data Mapping:** Simplify how you interact with your data.

## 🛠️ Troubleshooting
If you encounter issues:

- **Connection Errors:** Check your credentials for accuracy. Make sure the database is running.
- **Performance Issues:** Ensure your computer meets the minimum requirements.
